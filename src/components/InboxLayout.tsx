...
import { FiInbox, FiChevronLeft, FiChevronRight, FiFilter, FiMessageSquare, FiTool } from 'react-icons/fi';
...
export function InboxLayout() {
  ...
  // Left navigation icons specific to inbox
  const leftSidebarContent = (
    <VStack spacing={2} align="stretch" w="100%">
      ...
      <Tooltip label="Trades Directory" placement="right">
        <Link href="/trades" passHref legacyBehavior>
          <IconButton
            as="a"
            icon={<FiTool />}
            aria-label="Trades Directory"
            variant="ghost"
            color="white"
            size="md"
            borderRadius="md"
